...
function ResultScreen({
  ...
  return (
    <>
      ...
      <div className="min-h-screen w-full flex flex-col" style={{ background: CONIC_BG }}>
        {/* Header */}
        <div
        ...
        {/* Tag groups */}
        <div className="flex-1 px-5 overflow-y-auto pb-36">
...
export default function OnboardingPage() {
  ...
  const handleSubmit = async () => {
    ...
    setUserPreferences({ categories, selectedTags: [...new Set(allTags)], completedAt: new Date().toISOString() });
